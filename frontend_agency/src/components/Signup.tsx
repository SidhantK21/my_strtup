    ...
    setTimeout(async () => {
      try {
        ...
        setTimeout(() => {
          ...
          onSignIn(); // Redirect to sign-in modal
        }, 1500);
        ...
        <div className="p-8 sm:p-10">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="pl-10 w-full px-4 py-3 bg-white/10 border border-white/10 rounded-xl 
                             focus:ring-2 focus:ring-white/20 focus:border-white/20 text-white 
            ...
            <motion.button
              ...
              type="submit"
              disabled={isLoading}
              className="w-full bg-gradient-to-r from-blue-500/80 to-indigo-600/80 text-white py-3 px-4 rounded-xl 
                         hover:from-blue-600/80 hover:to-indigo-700/80 flex items-center justify-center gap-2 
          ...
          <div className="mt-8 text-center">
            <p className="text-sm text-white/70">
              ...
              <button onClick={onSignIn} className="text-blue-400 hover:text-blue-300 font-medium">
                Sign In
              </button>
            </p>
          </div>
